...
function ContactUs(){
    return (
        <>
          <Jumbo image={card} text={'Contact Us'} />
          <Article title={'You can contact us at :'}>
            {
                contact_data.map(contact=>  <ContactCard title={contact.title} address={contact.address} email={contact.email} phone={contact.phone} />)
            }
<br /><br />
           ...
           <Article top={true} title={'Contact us'} content={[
